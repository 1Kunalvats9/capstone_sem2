...
const page = () => {
  ...
  return (
    <>
      <Navbar cs="" />
      <div className='w-full min-h-[80vh] lg:px-28 md:px-16 px-10 mb-10'>
        <div className="flex h-[700px] w-full">
          <div className="w-full hidden md:inline-block">
            <img className="h-full object-cover" src="https://www.adanirealty.com/-/media/project/realty/blogs/types-of-residential-properties.ashx" alt="leftSideImage" />
          </div>
              ...
              openSignUp ?
                <>
                  <form className="md:w-96 w-80 flex flex-col items-center justify-center" onSubmit={handleSignUp}>
                    ...
                    <p className="text-sm text-gray-500/90 mt-3">Welcome! Please Signup to continue</p>
                    ...
                    <div className="flex items-center mt-10 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                      ...
                      <input type="text" placeholder="Full Name" className="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required onChange={(e) => { setName(e.target.value) }} />
                    </div>
                    ...
                    <button type="submit" className="mt-8 w-full h-11 rounded-full text-white bg-[#165DFB] hover:opacity-90 transition-opacity cursor-pointer">
                      Sign Up
                    </button>
                ...
                <>
                  <form className="md:w-96 w-80 flex flex-col items-center justify-center" onSubmit={handleLogin}>
                    ...
                    <p className="text-gray-500/90 text-sm mt-4">Don’t have an account? <a className="text-indigo-400 hover:underline" onClick={() => { setOpenSignUp(true) }} href="#">Sign up</a></p>
                  </form>
                </>
            }
          </div>
