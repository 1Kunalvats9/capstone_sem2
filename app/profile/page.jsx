...
import { Plus, Home, Heart, Gavel } from 'lucide-react';
                                                    ...
                                                    <div key={bid._id} className="glass-effect rounded-xl p-6 border border-slate-700 hover:border-slate-600 transition-colors">
                                                        <div className="flex justify-between items-start">
                                                            <div className="flex-1">
                                                                ...
                                                                <p className="text-slate-400 text-sm mb-2 font-light">{bid.property.location.city}, {bid.property.location.state}</p>
                                                                <div className="flex items-center gap-4 text-sm">
                                                                <span className="text-slate-400 font-light">
                                                                    Your Bid: <span className="text-green-400 font-bold">₹{bid.bidAmount.toLocaleString()}</span>
                                                                </span>
                                                                    <span className="text-slate-400 font-light">
                                                                    Highest Bid: <span className="text-blue-400 font-bold">₹{bid.property.currentHighestBid.toLocaleString()}</span>
                                                                </span>
                                                                </div>
                                                            </div>
